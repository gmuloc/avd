...
class EthernetInterfacesMixin(UtilsMixin):
    ...
    def ethernet_interfaces(self: AvdStructuredConfigUnderlay) -> list | None:
        ...
        for link in self._underlay_links:
            ...
            if link["type"] == "underlay_p2p":
                self._underlay_p2p_link(link, ethernet_interface, ethernet_interfaces)

            # L2 interface
            elif link["type"] == "underlay_l2":
                self._underlay_l2_link(link, ethernet_interface, ethernet_interfaces)


        # Support l3_interface as sub interfaces
        self._l3_sub_interfaces(ethernet_interfaces)

        # WAN HA interfaces for direct connection
        if self.shared_utils.use_uplinks_for_wan_ha is False:
            self._wan_direct_ha_interfaces(ethernet_interfaces)
    ...
    def _underlay_p2p_link(self: AvdStructuredConfigUnderlay, link: dict, ethernet_interface: dict, ethernet_interfaces: list) -> None:
        """TODO.
        """
    ...
    def _underlay_l2_link(self: AvdStructuredConfigUnderlay, link: dict, ethernet_interface: dict, ethernet_interfaces: list) -> None:
        """TODO."""
        ethernet_subinterfaces: list[dict] = []
    ...
    def _wan_direct_ha_interfaces(self: AvdStructuredConfigUnderlay, ethernet_interfaces: list) -> None:
        """TODO."""
    ...
    def _l3_sub_interfaces(self: AvdStructuredConfigUnderlay, ethernet_interfaces: list) -> None:
        """TODO."""
