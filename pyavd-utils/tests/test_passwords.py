import pytest
from pyavd_utils._passwords import sha512_crypt

SHA512_CRYPT_TEST_DATA = [
    pytest.param("arista",  "1234567890ABCDEF", "$6$1234567890ABCDEF$5h/.K2RuwSPqXTncNaqmw./4HduYZNE4RHDfivjrQ8nrYX3AcB8gKSsKFC1VSVOl3E46/QFZ85uHZWhxQGTeS0", id="Valid hash with Salt")
]
