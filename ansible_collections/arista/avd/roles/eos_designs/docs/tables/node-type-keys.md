...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;default_autovpn_role</samp>](## "node_type_keys.[].default_autovpn_role") | String |  |  | Valid Values:<br>- <code>client</code><br>- <code>server</code> | Default autovpn_role. Can be overridden in topology vars. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;default_avt_role</samp>](## "node_type_keys.[].default_avt_role") | String |  |  | Valid Values:<br>- <code>pathfinder</code><br>- <code>edge</code><br>- <code>transit</code> | Default avt_role. Can be overridden in topology vars. |
...
=== "YAML"
    ...
    node_type_keys:
      - key: <str; required; unique>
        ...
        # Default autovpn_role. Can be overridden in topology vars.
        default_autovpn_role: <str; "client" | "server">

        # Default avt_role. Can be overridden in topology vars.
        default_avt_role: <str; "pathfinder" | "edge" | "transit">
